...
export type AttachmentReclaimPreview = {
  ...
  kept: Partial<Record<'session-still-open' | 'no-session-record' | 'resumed-later' | 'within-window' | 'referenced' | 'holds-agent-output' | 'changed-since-preview' | 'unreadable', number>>;
};
