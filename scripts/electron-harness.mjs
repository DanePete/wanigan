...
export async function launchWanigan(electron,{root,userData,env,args=[]}){
 ...
 const app=await electron.launch({executablePath:path.join(root,binary),args:[bootstrap,`--user-data-dir=${userData}`,'--wanigan-automation',...args],cwd:root,env,timeout:30_000});
 try{
